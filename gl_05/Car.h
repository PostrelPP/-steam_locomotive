...
public:
	...
	Car(glm::vec3 coordinates, ShaderProgram* shader, ShaderProgram* lampShader, const char* bodyTexture)
	{
		...
		Object* wheel1 = new Cylinder(coordinates - glm::vec3(-0.8f, 0.3f, 0.75f), { 0.3f,0.2f,0.3f }, "car_wheel.png", shader, { 90,0,0 });
		items.push_back(wheel1);
		Object* wheel2 = new Cylinder(coordinates - glm::vec3(0.8f, 0.3f, 0.75f), { 0.3f,0.2f,0.3f }, "car_wheel.png", shader, { 90,0,0 });
		items.push_back(wheel2);
		Object* wheel3 = new Cylinder(coordinates - glm::vec3(-0.8f, 0.3f, -0.75f), { 0.3f,0.2f,0.3f }, "car_wheel.png", shader, { 90,0,0 });
		items.push_back(wheel3);
		Object* wheel4 = new Cylinder(coordinates - glm::vec3(0.8f, 0.3f, -0.75f), { 0.3f,0.2f,0.3f }, "car_wheel.png", shader, { 90,0,0 });
		items.push_back(wheel4);
		Object* glass = new Cube(coordinates - glm::vec3(0.3f, -0.5f, 0.0), { 1.5, 0.5, 1.3 }, "glass.png", shader);
